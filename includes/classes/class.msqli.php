<?php
//require_once('../../../access_public.inc.php'); 
/**
 * MysqliDb Class
 *
...
class MysqliDb
{
    ...
    {
        return $this->_mysqli->real_escape_string(strip_tags($str));
    }
	
	public function escapeaddslashes($str)
    {
        return addslashes(trim(strip_tags($str)));
    }
	
	public function escapestripslashes($str)
    {
